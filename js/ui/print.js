...
$('#printBtn').addEventListener('click', async () => {
  ...
  setTimeout(() => { window.print(); setTimeout(() => area.innerHTML = '', 800); }, 250);
});
...
@media print{
  .app,.sheet,.drawer,.modal,.scope,.fview,.peek{display:none!important}
  .printArea{position:static;left:0}
  .printArea .page{page-break-after:always;break-after:page}
