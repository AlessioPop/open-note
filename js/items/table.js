...
/* ================= a table that came out of a file =================
   A workbook is read by js/lib/sheet.js, which knows nothing about this app and
...
/* ---- folded down to an icon ----
   A table of forty thousand readings belongs in the book, not spread over the
...
function openTable(it, page){
  tableWin = { it, page: page || activePage(), vr: 0, vh: 24 };
  const v = $('#fview');
