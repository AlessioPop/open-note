...
/* ---- the same wires, settled, for a print / an export / a thumbnail ----
   Built from scratch beside a page that has just been laid out, in the space
   the static strings use. Only wires with both ends on this one sheet: a page
   printed on its own has nowhere to draw the other half of a spread. */
