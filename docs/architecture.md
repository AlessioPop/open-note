...
tools/verify/       the harness: 912 assertions, driven in headless Firefox
```
...
**912 assertions**, and they are the real specification of this app. Among them:
...
colour map; that ethanol built by clicks says `C₂H₆O` and 46.07 and its 3D view
