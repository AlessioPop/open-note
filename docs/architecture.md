...
| `molecule.js` | 969 | `molecule` — the 2D editor with its glass rail and ChemDraw gestures, the hotkeys, the three drawing styles, the ⌕ name-or-SMILES box, and the 3D view: three looks, the momentum orbit, and picks that measure |
